...
def answer(filename1, filename2=None):
    ...
    if filename2 is None:
        ...
        if dict2['Размер аванса'] != dict1['Размер аванса']:
            ...
            if dict2['Размер аванса'] > dict1['Размер аванса']:
                answer += 'Аванса больше -> Инвест. затраты (основной долг клиента) погашаются быстрее -> Начислено меньше процентов за период лизинга'
            else:
                answer += 'Отсрочка меньше -> Инвест. затраты (основной долг клиента) погашаются медленнее -> Начислено больше процентов за период лизинга'
